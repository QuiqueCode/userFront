          ...
          <div className="ps-page__container">
              ...
              <div className="ps-product--detail ps-product--fullwidth">
                ...
                <div className="ps-product__header">
                  ...
                  <Carousel>
                    <Carousel.Item>
                      <img
                        ...
                        src="src/img/products/detail/countdown/1.jpg"
                        alt="Primer slide"
                    ...
                    <Carousel.Item>
                      <img
                        className="d-block w-100"
                        src="src/img/products/detail/countdown/2.jpg"
                        alt="Segundo slide"
                        style={{ height: "500px", objectFit: "cover" }}
                      />
                      <Carousel.Caption></Carousel.Caption>
                    ...
                    <Carousel.Item>
                      <img
                        className="d-block w-100"
                        src="src/img/products/detail/countdown/3.jpg"
                        alt="Segundo slide"
                        style={{ height: "500px", objectFit: "cover" }}
                      />
                      <Carousel.Caption></Carousel.Caption>
                  ...
                  <div className="ps-product__thumbnail" data-vertical="true">
                    ...
                    >
                      ...
                      <div className="item">
                        <img
                          src="src/img/products/detail/countdown/4.jpg"
                          alt
                        />
                      </div>
                    </div>
                  ...
                  <div className="ps-product__info">
                    ...
                    <div className="ps-product__meta">
                      <p>
                        Brand:<a href="shop-default.html">Gallaxy</a>
                      </p>
                    </div>
                    ...
                    <div className="ps-product__desc">
                      <p>
                        ...
                        <a className="mr-20" href="shop-default.html">
                          <strong> Tienda Juvenil</strong>
                        </a>
                        Status:
                        <a href="shop-default.html">
                          <strong className="ps-tag--in-stock">
                            {" "}
                            In stock
                          </strong>
                        </a>
                      ...
                      <ul className="ps-list--dot">
                        <li>
                          {" "}
                          Altavoz estéreo activo portátil y sin restricciones
                        </li>
                        <li> Libre de los confines de cables y cuerdas</li>
                        <li> 20 horas de capacidades portátiles</li>
                        <li>
                          {" "}
                          Cable en espiral de doble extremo con conectores
                    ...
                    <div className="ps-product__variations">
                      <figure>
                        <figcaption>
                          Color: <strong> Escoge una opcion</strong>
                        </figcaption>
                        <div className="ps-variant ps-variant--image">
                          <span className="ps-variant__tooltip">Azul</span>
                          <img
                            src="src/img/products/detail/variants/small-1.jpg"
                            alt
                          />
                        </div>
                        <div className="ps-variant ps-variant--image">
                          ...
                          <img
                            src="src/img/products/detail/variants/small-2.jpg"
                            alt
                          />
                        </div>
                        <div className="ps-variant ps-variant--image">
                          ...
                          <img
                            src="src/img/products/detail/variants/small-3.jpg"
                            alt
                          />
                        </div>
                      </figure>
                      <figure>
                        <figcaption>
                          Talla<strong> Escoge una opcion</strong>
                        </figcaption>
                    ...
                    <div className="ps-product__countdown">
                      <figure>
                        <figcaption>
                          {" "}
                          ¡No te lo pierdas! Esta promoción expirará en:
                        </figcaption>
                        <ul
                    ...
                    <div className="ps-product__specification">
                      ...
                      <p className="categories">
                        ...
                        <a href="#"> Refrigerador</a>,
                        <a href="#">Bebes &amp; Madres</a>
                      </p>
                      <p className="tags">
                        <strong> Tags</strong>
                        <a href="#">sofa</a>
                ...
                <div className="ps-product__content ps-tab-root">
                    ...
                    <div className="ps-block__content">
                      <div className="ps-block__items">
                          ...
                          <div className="ps-product ps-product--simple">
                            <div className="ps-product__thumbnail">
                              <a href="product-default.html">
                                <img
                                  src="src/img/products/furniture/12.jpg"
                                  alt
                                />
                              </a>
                            </div>
                            <div className="ps-product__container">
                              <div className="ps-product__content">
                                ...
                                >
                                  Sofá largo de tela de Corea en color azul
                                  marino
                                </a>
                        ...
                        <div className="ps-block__item">
                          <div className="ps-product ps-product--simple">
                            <div className="ps-product__thumbnail">
                              <a href="product-default.html">
                                <img
                                  src="src/img/products/furniture/13.jpg"
                                  alt
                                />
                              </a>
                            </div>
                        ...
                        <div className="ps-block__item ps-block__total">
                          <p>
                            Total Price:<strong> $1000.30</strong>
                          </p>
                          <a className="ps-btn" href="#">
                            Agregar Todo al carrito
                          </a>
                          <a
                            className="ps-btn ps-btn--gray ps-btn--outline"
                            href="#"
                          >
                            Agregar Todo a la lista deseos
                          </a>
                        </div>
                      </div>
                      <div className="ps-block__footer">
                        <div className="ps-checkbox">
                          <input
                            ...
                            defaultChecked
                          />
                          <label htmlFor="product-bought-1">
                            <strong>This item: </strong> Sofá largo de tela de
                            Corea en color azul marino <span>$679.80</span>
                          </label>
                        </div>
                        <div className="ps-checkbox">
                          <input
                            ...
                            defaultChecked
                          />
                          <label htmlFor="product-bought-2">
                            Fabric Chair In Brown Color <span>$120.80</span>
                          </label>
                        </div>
                      </div>
                    </div>
                  ...
                  <ul className="ps-tab-list">
                    <li className="active">
                      <a href="#tab-1">Descripcion</a>
                    </li>
                    <li>
                      <a href="#tab-2">Especificacion</a>
                    </li>
                    <li>
                      <a href="#tab-3">Vendedor</a>
                    </li>
                    <li>
                      <a href="#tab-4">Reseñas (1)</a>
                    </li>
                    <li>
                      <a href="#tab-5">Preguentas y Respuestas</a>
                    </li>
                    <li>
                      <a href="#tab-6">Mas Offertas</a>
                    </li>
                  </ul>
                  <div className="ps-tabs">
                    <div className="ps-tab active" id="tab-1">
                      <div className="ps-document">
                        <h5>
                          Encarnando el espíritu crudo y rebelde del rock and
                          roll
                        </h5>
                        <p>
                          Encarnando el espíritu crudo y rebelde del rock 'n'
                          roll, el altavoz estéreo activo portátil Kilburn
                          adopta el inconfundible aspecto y sonido de Marshall,
                          desenchufa los cables y lleva el espectáculo a la
                          carretera.
                        </p>
                        <p>
                          Con un peso inferior a 7 libras, el Kilburn es una
                          pieza de ingeniería de estilo vintage ligera.
                          Estableciendo la barra como uno de los altavoces más
                          ruidosos de su clase, el Kilburn es un héroe compacto
                          y de buen corazón con un audio bien equilibrado que
                          cuenta con un rango medio claro y agudos extendidos
                          para un sonido que es a la vez articulado y
                          pronunciado. Las perillas analógicas le permiten
                          ajustar los controles a sus preferencias personales,
                          mientras que la correa de cuero inspirada en la
                          guitarra permite un viaje fácil y elegante.
                        </p>
                        <img
                          className="mb-30"
                          src="src/img/products/detail/content/description.jpg"
                          alt
                        />
                        <h5>Que es lo que obtienes</h5>
                        <p>
                          El sonido de Marshall, desenchufa los cables y lleva
                          el espectáculo a la carretera..
                        </p>
                        <ul className="pl-0">
                          <li>
                            No FM radio (Excepto por las unidades de T-Mobile en
                        ...
                        <p>
                          Si has sumergido el teléfono en la bañera, deberás
                          secar el puerto de carga antes de enchufarlo. Samsung
                          no ha reinventado la rueda con el diseño del Galaxy
                          S7, pero no necesitaba hacerlo. El Galaxy S6 era un
                          dispositivo con un diseño excelente, y el S7 ha
                          logrado mejorar eso
                        </p>
                      </div>
                    </div>
            ...
            <div className="ps-page__right d-block d-sm-none d-xl-block">
              <aside className="widget widget_product widget_features">
                <p>
                  <i className="icon-network" /> Flete Internacional
                </p>
                <p>
                  <i className="icon-3d-rotate" /> Devolución gratuita de 7 días
                  si es elegible, muy fácil.
                </p>
                <p>
                  <i className="icon-receipt" /> El proveedor emite facturas
                  para este producto.
                </p>
                <p>
                  <i className="icon-credit-card" /> Paga cuando recibe los
                  productos
                </p>
              </aside>
              <aside className="widget widget_sell-on-site">
                <p>
                  <i className="icon-store" /> Vender en TikoMarket?
              ...
              <aside className="widget widget_same-brand">
                ...
                <div className="widget__content">
                      ...
                      <ul className="ps-product__actions">
                        ...
                        <li>
                          <a
                            ...
                            data-toggle="tooltip"
                            data-placement="top"
                            title="Agregar a la Lista Deseos"
                          >
                            <i className="icon-heart" />
                          </a>
                        </li>
                    ...
                    <div className="ps-product__container">
                      ...
                      <div className="ps-product__content">
                        <a
                          ...
                          href="product-default.html"
                        >
                          Novela del Gran Slam Indoor de Salto de Obstáculos
                        </a>
                  ...
                  <div className="ps-product">
                    <div className="ps-product__thumbnail">
                      <a href="product-default.html">
                        <img src="src/img/products/shop/6.jpg" alt />
                      </a>
              ...
              <div className="row">
                    ...
                    <div className="ps-product__container">
                      ...
                      <div className="ps-product__content">
                        <a
                          ...
                          href="product-default.html"
                        >
                          Xbox One Controlador Inalambrico Color Negro
                        </a>
                        <div className="ps-product__rating">
                          <select className="ps-rating" data-read-only="true">
                            <option value={1}>1</option>
                ...
                <div className="col-lg-2 col-md-4 col-6 ">
                  <div className="ps-product">
                    <div className="ps-product__thumbnail">
                      <a href="product-default.html">
                        <img src="src/img/products/shop/1.jpg" alt />
                      </a>
                      <div className="ps-product__badge">-5%</div>
                      <ul className="ps-product__actions">
                        <li>
                        ...
                        <li>
                          <a
                            ...
                            data-toggle="tooltip"
                            data-placement="top"
                            title="Agregar a las Lista Deseos"
                          >
                            <i className="icon-heart" />
                          </a>
                        </li>
